...
function projectDate(tab) {
    ...
    arr.forEach((proj) => {
        ;(0,_DOM__WEBPACK_IMPORTED_MODULE_1__.iterate2)(proj,tab)
    })
...
function taskDate() {
    ...
    const arr = _controller__WEBPACK_IMPORTED_MODULE_0__.todoList.filter((proj) => {
        ...
        if((0,date_fns_esm__WEBPACK_IMPORTED_MODULE_4__["default"])(testdate,today )){
            return true
        }
    })
}
